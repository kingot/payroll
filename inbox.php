...
<header>
 <?php include 'includes/managerMenu.php';?>  
  ...
  <div class="container">
  <br/>
	<h3>Read Your Messages</h3>
    
    <?php
	
	
    $sql = "SELECT inboxId,inbox.username AS username,title,content,viewed,recievedDate, managerlog.empId FROM inbox
    	JOIN managerlog ON managerlog.empId='".$_SESSION['empId']."' WHERE managerlog.empId=inbox.empId ORDER BY inboxId DESC LIMIT 1000";
 ...
 <div class="inbox-outbox"> <table cellpadding="0" cellspacing="0" border="0">
  <form action="" method="post">
   ...
   <td width="50" height="21"><input type="checkbox" name="checkbox" value="<?php echo $rows['inboxId']; ?>"></td>
    ...
    <td width="364" align="left"><a href="view-inbox.php?in=<?php echo $rows['inboxId'];?>"><b><?php echo $rows['title']?></b></a></td>
   ...
   <td><input type="checkbox" name="checkbox" value="<?php echo $rows['inboxId']; ?>"></td>
    <td><a href="view-inbox.php?in=<?php echo $rows['inboxId'];?>"><?php echo $rows['title']?></a></td>
