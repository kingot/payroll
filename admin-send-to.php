...
$error=array();
   ...
   // $sql="SELECT empId, name FROM employee WHERE empId='$sendTo'";
		...
		if(empty($title) || empty($toUser)|| empty($message)){
	  ...
	  $errorAll= '<div class="error"><ul><li>'.implode('</li><li>',$error).'</li></ul></div>';
		...
		echo '<p class="pa">Message sent sucessfully.&nbsp;<a href="admin-outbox.php">View Message</a></p>';
...
<form action="admin-send-to.php" method="POST">
